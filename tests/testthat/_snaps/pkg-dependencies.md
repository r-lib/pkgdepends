...
---
    ...
    Output
       ...
       [7] "http_retry"                "ignore_dev_library"       
       [9] "include_linkingto"         "library"                  
      [11] "metadata_cache_dir"        "metadata_update_after"    
      [13] "package_cache_dir"         "platforms"                
      [15] "r_versions"                "sysreqs"                  
      [17] "sysreqs_db_update"         "sysreqs_db_update_timeout"
      [19] "sysreqs_dry_run"           "sysreqs_lookup_system"    
      [21] "sysreqs_platform"          "sysreqs_rspm_repo_id"     
      [23] "sysreqs_rspm_url"          "sysreqs_sudo"             
      [25] "sysreqs_update"            "sysreqs_verbose"          
      [27] "use_bioconductor"          "windows_archs"            
