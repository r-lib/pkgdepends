...
```
    ...
    #> ℹ Getting 12 pkgs (12.66 MB), 5 (1.71 MB) cached                                
...
```
    ...
    #> 1 /tmp/RtmpgaCw… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Packaged pkgconfig 2.0.2 (575ms)                                              
    #> ℹ Building pkgconfig 2.0.2                                                      
    #> ✔ Built pkgconfig 2.0.2 (934ms)                                                 
    #> ✔ Installed pkgconfig 2.0.2 (github::cran/pkgconfig@d892880) (1s)               
    #> ✔ Summary:   1 new  in 2s                                                       
    #> # A data frame: 1 × 32                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpgaCw… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Installed pkgconfig 2.0.3  (20ms)                                             
    #> ✔ Summary:   1 updated  in 20ms                                                 
    #> # A data frame: 1 × 31                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpgaCw… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
