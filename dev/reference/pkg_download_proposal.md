...
#> ## metadata_cache_dir
#> <default>
#> [1] "/tmp/RtmpL2FPan/file1f1824724a97"
#> 
#> ## platforms
#> <default>
...
#> ✔ Got ps 1.9.3 (x86_64-pc-linux-gnu-ubuntu-24.04) (506.16 kB)
...
#> ✔ Cached copy of processx 3.9.0 (source) is the latest build
...
#> ✔ Got fs 2.1.0 (x86_64-pc-linux-gnu-ubuntu-24.04) (240.74 kB)
...
#> 10 ps        standard FALSE  FALSE     OK     ps        1.9.3   MIT + …
#> # ℹ 16 more rows
#> # ℹ 33 more variables: needscompilation <lgl>, priority <chr>,
#> #   md5sum <chr>, sha256 <chr>, filesize <int>, built <chr>,
#> #   platform <chr>, rversion <chr>, repotype <chr>, repodir <chr>,
...
pdl$download()
#> ℹ Getting 5 pkgs (2.00 MB) and 14 pkgs with unknown sizes, 8 (1.95 MB) cached
#> ✔ Cached copy of pkgdepends 0.9.1.9000 (source) is the latest build
#> ✔ Cached copy of cli 3.6.6 (source) is the latest build
#> ✔ Cached copy of curl 7.1.0 (source) is the latest build
