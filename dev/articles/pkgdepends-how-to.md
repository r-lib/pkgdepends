...
```
    ...
    #> ✔ Packaged pkgconfig 2.0.2 (495ms)                                              
    #> ℹ Building pkgconfig 2.0.2                                                      
    #> ✔ Built pkgconfig 2.0.2 (594ms)                                                 
    #> ✔ Installed pkgconfig 2.0.2 (github::cran/pkgconfig@d892880) (12ms)             
    #> ✔ Summary:   1 new  in 605ms                                                    
    #> # A data frame: 1 × 32                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpBmOm… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Installed pkgconfig 2.0.3  (10ms)                                             
    #> ✔ Summary:   1 updated  in 10ms                                                 
    #> # A data frame: 1 × 31                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpBmOm… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
