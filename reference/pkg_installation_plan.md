...
[`pkgdepends::pkg_installation_proposal`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.md)
...
- [`pkgdepends::pkg_installation_proposal$async_download()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-async_download)
- [`pkgdepends::pkg_installation_proposal$create_lockfile()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-create_lockfile)
- [`pkgdepends::pkg_installation_proposal$download()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-download)
- [`pkgdepends::pkg_installation_proposal$draw()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-draw)
- [`pkgdepends::pkg_installation_proposal$get_config()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_config)
- [`pkgdepends::pkg_installation_proposal$get_downloads()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_downloads)
- [`pkgdepends::pkg_installation_proposal$get_install_plan()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_install_plan)
- [`pkgdepends::pkg_installation_proposal$get_refs()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_refs)
- [`pkgdepends::pkg_installation_proposal$get_resolution()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_resolution)
- [`pkgdepends::pkg_installation_proposal$get_solution()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_solution)
- [`pkgdepends::pkg_installation_proposal$get_sysreqs()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-get_sysreqs)
- [`pkgdepends::pkg_installation_proposal$install()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-install)
- [`pkgdepends::pkg_installation_proposal$install_sysreqs()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-install_sysreqs)
- [`pkgdepends::pkg_installation_proposal$print()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-print)
- [`pkgdepends::pkg_installation_proposal$show_solution()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-show_solution)
- [`pkgdepends::pkg_installation_proposal$show_sysreqs()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-show_sysreqs)
- [`pkgdepends::pkg_installation_proposal$stop_for_download_error()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-stop_for_download_error)
- [`pkgdepends::pkg_installation_proposal$stop_for_solution_error()`](https://r-lib.github.io/pkgdepends/reference/pkg_installation_proposal.html#method-stop_for_solution_error)
