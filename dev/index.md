...
```
    ...
    ## ✔ Updated metadata database: 3.65 MB in 8 files.
...
```
    ...
    ## ✔ Packaged cli 3.6.6.9000 (1.2s)
    ## ℹ Building cli 3.6.6.9000
    ## ✔ Built cli 3.6.6.9000 (7.7s)
    ## ✔ Installed cli 3.6.6.9000 (github::r-lib/cli@86bdefe) (27ms)
    ## ✔ Summary:   1 new  in 7.8s
