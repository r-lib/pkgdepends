...
```
    ...
    #> ✔ Built pkgconfig 2.0.3 (819ms)                                                 
    #> ✔ Installed pkgconfig 2.0.3  (16ms)                                             
    #> ✔ Summary:   1 new  in 834ms                                                    
    #> # A data frame: 1 × 31                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpMQEi… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Packaged pkgconfig 2.0.2 (465ms)                                              
    #> ℹ Building pkgconfig 2.0.2                                                      
    #> ✔ Built pkgconfig 2.0.2 (824ms)                                                 
    #> ✔ Installed pkgconfig 2.0.2 (github::cran/pkgconfig@d892880) (16ms)             
    #> ✔ Summary:   1 new  in 839ms                                                    
    #> # A data frame: 1 × 32                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpMQEi… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
