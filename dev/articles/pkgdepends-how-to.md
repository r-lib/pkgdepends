...
```
    ...
    #> ✔ Built pkgconfig 2.0.3 (881ms)                                                 
    #> ✔ Installed pkgconfig 2.0.3  (19ms)                                             
    #> ✔ Summary:   1 new  in 900ms                                                    
    #> # A data frame: 1 × 31                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpjaX0… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Packaged pkgconfig 2.0.2 (539ms)                                              
    #> ℹ Building pkgconfig 2.0.2                                                      
    #> ✔ Built pkgconfig 2.0.2 (884ms)                                                 
    #> ✔ Installed pkgconfig 2.0.2 (github::cran/pkgconfig@d892880) (19ms)             
    #> ✔ Summary:   1 new  in 903ms                                                    
    #> # A data frame: 1 × 32                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpjaX0… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
