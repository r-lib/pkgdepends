...
```
    ...
    #> ✔ Packaged pkgconfig 2.0.2 (535ms)                                              
    ...
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpfLGM… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Installed pkgconfig 2.0.3  (46ms)                                             
    #> ✔ Summary:   1 updated  in 46ms                                                 
    #> # A data frame: 1 × 31                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpfLGM… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
